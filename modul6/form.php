            ...
            <table border='0' width='30%'>
                <form method='post' action='form.php'>
                    <tr>
                        ...
                        <td width='5%'>:</td>
                        <td width='65%'><input type='text' name='kode_buku' size='10' required></td>
                    </tr>
                    <tr>
                        <td width='25%'>Nama Buku</td>
                        <td width='5%'>:</td>
                        <td width='65%'><input type='text' name='nama_buku' size='30' required></td>
                    </tr>
                    <tr>
                        ...
                        <input type='submit' value='Masukan' name='submit' required>
